...
##### Public API v1.1: CustomerOrder <span class="ticket">ID-287</span>  
 Our updated order management tools now offer a more consistent and efficient integration experience through improved paging and standardized request handling.  
...
##### Public API v1.1: ItemCost <span class="ticket">ID-292</span>  
 Our updated ItemCost integration now features improved paging and standardized data access to provide a more consistent and efficient experience for developers and partners.  
  <span class="new">New Feature</span>  
...
##### Public API v1.1: SalesSummary <span class="ticket">ID-307</span>  
 Partners can now access sales summary data more efficiently with improved data retrieval standards for a more consistent and predictable experience.  
  <span class="new">New Feature</span>  
...
##### Retalia Lite Rebrand: Backoffice <span class="ticket">ID-343</span>  
 We've refreshed the Backoffice user interface with the new Retalia branding, including updated logos, fonts, and colours, while maintaining the familiar layout and functionality.  
  <span class="new">New Feature</span>  
